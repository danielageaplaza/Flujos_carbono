...
#Mostrámos con un grafico de lineas la serie temporal completa, para cada flujo y lugar por separado
...
#Nacimiento CO2  
  ...
  ggplot(datos_filtrados, aes(x = Date, y = mean_flux, color = Treatment)) +
    geom_line(size = 1) +  # Aumentar grosor de las l?neas
    geom_point(size = 2) +    # Aumentar tama?o de los puntos
